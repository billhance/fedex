...
*/
class FedEx_LocatorService_Notification
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_LocatorService_Notification
     */
    public function setSeverity(FedEx_LocatorService_NotificationSeverityType $severity)
    {
