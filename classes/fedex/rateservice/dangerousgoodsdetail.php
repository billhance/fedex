...
*/
class FedEx_RateService_DangerousGoodsDetail
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_RateService_DangerousGoodsDetail
     */
    public function setAccessibility(FedEx_RateService_DangerousGoodsAccessibilityType $accessibility)
    {
     ...
     * return FedEx_RateService_DangerousGoodsDetail
     */
    public function setPackaging(FedEx_RateService_HazardousCommodityPackagingDetail $packaging)
    {
