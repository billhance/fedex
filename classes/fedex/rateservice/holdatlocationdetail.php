...
*/
class FedEx_RateService_HoldAtLocationDetail
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_RateService_HoldAtLocationDetail
     */
     ...
     * return FedEx_RateService_HoldAtLocationDetail
     */
    public function setLocationContactAndAddress(FedEx_RateService_ContactAndAddress $locationContactAndAddress)
    {
     ...
     * return FedEx_RateService_HoldAtLocationDetail
     */
    public function setLocationType(FedEx_RateService_FedExLocationType $locationType)
    {
