...
*/
class FedEx_RateService_FreightServiceCenterDetail
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_RateService_FreightServiceCenterDetail
     */
     ...
     * return FedEx_RateService_FreightServiceCenterDetail
     */
    public function setLocalService(FedEx_RateService_ServiceType $localService)
    {
     ...
     * return FedEx_RateService_FreightServiceCenterDetail
     */
    public function setLocalDistance(FedEx_RateService_Distance $localDistance)
    {
     ...
     * return FedEx_RateService_FreightServiceCenterDetail
     */
    public function setLocalServiceScheduling(FedEx_RateService_FreightServiceSchedulingType $localServiceScheduling)
    {
     ...
     * return FedEx_RateService_FreightServiceCenterDetail
     */
    public function setContactAndAddress(FedEx_RateService_ContactAndAddress $contactAndAddress)
    {
