...
*/
class FedEx_RateService_ShippingDocumentEMailRecipient
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_RateService_ShippingDocumentEMailRecipient
     */
    public function setRecipientType(FedEx_RateService_EMailNotificationRecipientType $recipientType)
    {
