...
*/
class FedEx_RateService_RateDiscount
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_RateService_RateDiscount
     */
    public function setRateDiscountType(FedEx_RateService_RateDiscountType $rateDiscountType)
    {
