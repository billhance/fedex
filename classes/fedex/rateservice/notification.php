...
*/
class FedEx_RateService_Notification
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_RateService_Notification
     */
    public function setSeverity(FedEx_RateService_NotificationSeverityType $severity)
    {
