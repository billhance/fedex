...
*/
class FedEx_RateService_EMailNotificationRecipient
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_RateService_EMailNotificationRecipient
     */
    public function setEMailNotificationRecipientType(FedEx_RateService_EMailNotificationRecipientType $eMailNotificationRecipientType)
    {
     ...
     * return FedEx_RateService_EMailNotificationRecipient
     */
    public function setFormat(FedEx_RateService_EMailNotificationFormatType $format)
    {
        $this->Format = $format;
        return $this;
    }
