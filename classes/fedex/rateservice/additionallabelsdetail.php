...
*/
class FedEx_RateService_AdditionalLabelsDetail
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_RateService_AdditionalLabelsDetail
     */
    public function setType(FedEx_RateService_AdditionalLabelsType $type)
    {
        $this->Type = $type;
        return $this;
    }
