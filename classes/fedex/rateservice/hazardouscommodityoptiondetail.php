...
*/
class FedEx_RateService_HazardousCommodityOptionDetail
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_RateService_HazardousCommodityOptionDetail
     */
    public function setLabelTextOption(FedEx_RateService_HazardousCommodityLabelTextOptionType $labelTextOption)
    {
