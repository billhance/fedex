...
*/
class FedEx_RateService_CustomsClearanceDetail
    extends FedEx_AbstractComplexType
{
     ...
     *
     * @param Party $Broker
     * return FedEx_RateService_CustomsClearanceDetail
     */
     ...
     * return FedEx_RateService_CustomsClearanceDetail
     */
    public function setRecipientCustomsId(FedEx_RateService_RecipientCustomsId $recipientCustomsId)
    {
     ...
     * return FedEx_RateService_CustomsClearanceDetail
     */
    public function setFreightOnValue(FedEx_RateService_FreightOnValueType $freightOnValue)
    {
