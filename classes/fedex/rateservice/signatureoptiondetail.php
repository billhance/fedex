...
*/
class FedEx_RateService_SignatureOptionDetail
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_RateService_SignatureOptionDetail
     */
    public function setOptionType(FedEx_RateService_SignatureOptionType $optionType)
    {
