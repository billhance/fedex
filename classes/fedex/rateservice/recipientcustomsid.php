...
*/
class FedEx_RateService_RecipientCustomsId
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_RateService_RecipientCustomsId
     */
    public function setType(FedEx_RateService_RecipientCustomsIdType $type)
    {
        $this->Type = $type;
        return $this;
    }
