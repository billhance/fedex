...
*/
class FedEx_ReturnTagService_Notification
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_ReturnTagService_Notification
     */
    public function setSeverity(FedEx_ReturnTagService_NotificationSeverityType $severity)
    {
