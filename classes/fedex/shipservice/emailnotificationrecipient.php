...
*/
class FedEx_ShipService_EMailNotificationRecipient
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_ShipService_EMailNotificationRecipient
     */
    public function setEMailNotificationRecipientType(FedEx_ShipService_EMailNotificationRecipientType $eMailNotificationRecipientType)
    {
     ...
     * return FedEx_ShipService_EMailNotificationRecipient
     */
    public function setFormat(FedEx_ShipService_EMailNotificationFormatType $format)
    {
        $this->Format = $format;
        return $this;
    }
