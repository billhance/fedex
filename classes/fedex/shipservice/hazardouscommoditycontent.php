...
*/
class FedEx_ShipService_HazardousCommodityContent
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_ShipService_HazardousCommodityContent
     */
    public function setDescription(FedEx_ShipService_HazardousCommodityDescription $description)
    {
