...
*/
class FedEx_ShipService_Payment
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_ShipService_Payment
     */
    public function setPaymentType(FedEx_ShipService_PaymentType $paymentType)
    {
     ...
     * return FedEx_ShipService_Payment
     */
    public function setPayor(FedEx_ShipService_Payor $payor)
    {
        $this->Payor = $payor;
        return $this;
    }
