...
*/
class FedEx_ShipService_TaxpayerIdentification
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_ShipService_TaxpayerIdentification
     */
    public function setTinType(FedEx_ShipService_TinType $tinType)
    {
