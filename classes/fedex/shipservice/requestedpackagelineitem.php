...
*/
class FedEx_ShipService_RequestedPackageLineItem
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_ShipService_RequestedPackageLineItem
     */
     ...
     * return FedEx_ShipService_RequestedPackageLineItem
     */
    public function setInsuredValue(FedEx_ShipService_Money $insuredValue)
    {
     ...
     * return FedEx_ShipService_RequestedPackageLineItem
     */
    public function setPhysicalPackaging(FedEx_ShipService_PhysicalPackagingType $physicalPackaging)
    {
     ...
     * return FedEx_ShipService_RequestedPackageLineItem
     */
    public function setSpecialServicesRequested(FedEx_ShipService_PackageSpecialServicesRequested $specialServicesRequested)
    {
