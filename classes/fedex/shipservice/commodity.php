...
*/
class FedEx_ShipService_Commodity
    extends FedEx_AbstractComplexType
{
     ...
     *
     * @param string $Name
     * return FedEx_ShipService_Commodity
     */
     ...
     * return FedEx_ShipService_Commodity
     */
    public function setUnitPrice(FedEx_ShipService_Money $unitPrice)
    {
     ...
     * return FedEx_ShipService_Commodity
     */
    public function setNaftaDetail(FedEx_ShipService_NaftaCommodityDetail $naftaDetail)
    {
