...
*/
class FedEx_ShipService_PackageRateDetail
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_ShipService_PackageRateDetail
     */
     ...
     * return FedEx_ShipService_PackageRateDetail
     */
    public function setBillingWeight(FedEx_ShipService_Weight $billingWeight)
    {
     ...
     * return FedEx_ShipService_PackageRateDetail
     */
    public function setDimWeight(FedEx_ShipService_Weight $dimWeight)
    {
     ...
     * return FedEx_ShipService_PackageRateDetail
     */
    public function setOversizeWeight(FedEx_ShipService_Weight $oversizeWeight)
    {
     ...
     * return FedEx_ShipService_PackageRateDetail
     */
    public function setBaseCharge(FedEx_ShipService_Money $baseCharge)
    {
     ...
     * return FedEx_ShipService_PackageRateDetail
     */
    public function setNetFreight(FedEx_ShipService_Money $netFreight)
    {
     ...
     * return FedEx_ShipService_PackageRateDetail
     */
    public function setNetFedExCharge(FedEx_ShipService_Money $netFedExCharge)
    {
     ...
     * return FedEx_ShipService_PackageRateDetail
     */
    public function setNetCharge(FedEx_ShipService_Money $netCharge)
    {
