...
*/
class FedEx_ShipService_HoldAtLocationDetail
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_ShipService_HoldAtLocationDetail
     */
     ...
     * return FedEx_ShipService_HoldAtLocationDetail
     */
    public function setLocationContactAndAddress(FedEx_ShipService_ContactAndAddress $locationContactAndAddress)
    {
     ...
     * return FedEx_ShipService_HoldAtLocationDetail
     */
    public function setLocationType(FedEx_ShipService_FedExLocationType $locationType)
    {
