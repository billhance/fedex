...
*/
class FedEx_ShipService_Notification
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_ShipService_Notification
     */
    public function setSeverity(FedEx_ShipService_NotificationSeverityType $severity)
    {
