...
*/
class FedEx_PickupService_TaxpayerIdentification
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_PickupService_TaxpayerIdentification
     */
    public function setTinType(FedEx_PickupService_TinType $tinType)
    {
