...
*/
class FedEx_PickupService_Payment
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_PickupService_Payment
     */
    public function setPaymentType(FedEx_PickupService_PaymentType $paymentType)
    {
     ...
     * return FedEx_PickupService_Payment
     */
    public function setPayor(FedEx_PickupService_Payor $payor)
    {
        $this->Payor = $payor;
        return $this;
    }
     ...
     * return FedEx_PickupService_Payment
     */
    public function setAmount(FedEx_PickupService_Money $amount)
    {
        $this->Amount = $amount;
        return $this;
    }
