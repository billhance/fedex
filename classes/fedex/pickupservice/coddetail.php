...
*/
class FedEx_PickupService_CodDetail
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_PickupService_CodDetail
     */
    public function setCodCollectionAmount(FedEx_PickupService_Money $codCollectionAmount)
    {
     ...
     * return FedEx_PickupService_CodDetail
     */
    public function setAddTransportationCharges(FedEx_PickupService_CodAddTransportationChargesType $addTransportationCharges)
    {
     ...
     * return FedEx_PickupService_CodDetail
     */
    public function setCollectionType(FedEx_PickupService_CodCollectionType $collectionType)
    {
     ...
     * return FedEx_PickupService_CodDetail
     */
    public function setCodRecipient(FedEx_PickupService_Party $codRecipient)
    {
     ...
     * return FedEx_PickupService_CodDetail
     */
    public function setReferenceIndicator(FedEx_PickupService_CodReturnReferenceIndicatorType $referenceIndicator)
    {
