...
*/
class FedEx_PickupService_CustomDeliveryWindowDetail
    extends FedEx_AbstractComplexType
{
     ...
     * return FedEx_PickupService_CustomDeliveryWindowDetail
     */
    public function setType(FedEx_PickupService_CustomDeliveryWindowType $type)
    {
        $this->Type = $type;
        return $this;
    }
     ...
     * return FedEx_PickupService_CustomDeliveryWindowDetail
     */
    public function setRequestRange(FedEx_PickupService_DateRange $requestRange)
    {
